...
from gold.field_data_gold_processing import process_field_data_for_gold_zone
...
class FieldFileProcessor(FileProcessor):
    ...
    def ingest(self):
        print("Ingesting field file...")
        # Add field-specific Ingestion logic
        process_field_data_for_gold_zone(self.fileId, self.fileName)